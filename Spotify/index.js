...
// [3] Songs List
let audio = new Audio('/spotify/music/bones.mp3');
let audio1 = new Audio('/spotify/music/believer.mp3');
let audio2 = new Audio('/spotify/music/enemy.mp3');
let audio3 = new Audio('/spotify/music/fearless.mp3');
let audio4 = new Audio('/spotify/music/heymama.mp3');
let audio5 = new Audio('/spotify/music/magenta riddim.mp3');
let audio6 = new Audio('/spotify/music/natural.mp3');
let audio7 = new Audio('/spotify/music/polozhenie.mp3');
let audio8 = new Audio('/spotify/music/sahara.mp3');
let audio9 = new Audio('/spotify/music/warriors.mp3');
// [4] Pause/Play
